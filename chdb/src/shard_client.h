...
public:
    ...
    bool getMajorNum(int *group,int &result);
    void rollbackvar(int key,int oldvar);
    /**
    ...
    //map tx_id to commands
    std::map<int, std::vector<chdb_protocol::command>> commands;
